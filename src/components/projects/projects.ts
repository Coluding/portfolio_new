...
export const projects: ProjectTemplateProps[] = [
    ...
    },
    {
        ...
        summary: "This project is about model based Reinforcement Learning. I implemented several model based RL research papers. Currently, I am experimenting with different model architectures and training methods. Papers I considered are 'World Models', 'Learning Learning Latent Dynamics for Planning from Pixels' and 'Dream to Control: Learning Behaviors by Latent Imagination'." ,
